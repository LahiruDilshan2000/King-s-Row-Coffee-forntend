...
const Login = ():JSX.Element => {
    ...
    return (
        <section className={'w-full h-[100vh] flex justify-center items-center bg-[url(src/assets/pexels-ian-frallon-pictures-3289960.jpg)]'}>
            <div className={`w-[60vw] h-[85vh] border-[1px] border-gray-400 p-3 flex bg-white  ${isLogin && 'flex-row-reverse' } `}>
                <div className={`w-[40%] h-full bg-[url(src/assets/pexels-ian-frallon-pictures-3289960.jpg)] bg-cover overflow-hidden`}>
                ...
                <div className={'w-[60%] h-full px-20 pt-20 '}>
                    <h1 className={'font-round text-[1.6rem] font-[600] text-gray-600 my-1'}>Welcome to King's Row System</h1>
                    ...
                    <h1 className={'mt-14 font-round text-sm text-gray-400 cursor-default '}>Don't have a Row account ?
                        <span className={'underline ml-1 cursor-pointer text-blue-500 active:text-red-500'}> Register now </span></h1>
                </div>
            </div>
        </section>
    );

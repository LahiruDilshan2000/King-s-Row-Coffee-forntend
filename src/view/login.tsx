...
const Login = ():JSX.Element => {
    return (
        <section className={'w-full h-[100vh] flex justify-center items-center bg-[url(src/assets/pexels-ian-frallon-pictures-3289960.jpg)]'}>
            <div className={'w-[60vw] h-[85vh] border-[1px] border-gray-400 p-3 flex bg-white'}>
                ...
                <div className={'w-[60%] h-full px-20 pt-20'}>
                    ...
                    <h1 className={'mt-14 font-round text-sm text-gray-400 cursor-default '}>Don't have a Row account ?
                        <span className={'underline ml-1 cursor-pointer text-gray-600'}> Register now </span></h1>
                </div>
            </div>
        </section>
    );

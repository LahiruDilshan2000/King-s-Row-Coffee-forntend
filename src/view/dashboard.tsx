...
const Dashboard = ():JSX.Element => {
    ...
    return (
        <section className={'w-full h-full bg-[#f6f4f4] overflow-y-scroll'}>
            ...
            <div className="row">
                ...
                <div className="col-md-8 col-sm-6 pr-10 py-2">
                    <div className={'w-full h-full rounded-lg bg-white shadow-[rgba(50,_50,_105,_0.01)_0px_2px_1px_0px,_rgba(0,_0,_0,_0.1)_0px_1px_2px_0px]'}>
                        {<DashboardRevenue/>}
                    </div>
                </div>
            </div>
